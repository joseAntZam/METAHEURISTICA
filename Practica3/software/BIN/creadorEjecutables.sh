...
nombre_ejecutable="fitnnes_tiempo"
...
if [ "$algoritmo" -eq 1 ]; then
    nombre_archivo="ejecucion_BMB.txt"
elif [ "$algoritmo" -eq 2 ]; then
    nombre_archivo="ejecucion_ILS.txt"
elif [ "$algoritmo" -eq 3 ]; then
    nombre_archivo="ejecucion_ES.txt"
elif [ "$algoritmo" -eq 4 ]; then
    nombre_archivo="BL.txt"
elif [ "$algoritmo" -eq 5 ]; then
    nombre_archivo="ejecucion_ILS_ES.txt"
fi
